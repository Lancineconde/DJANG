...
class InvoiceForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'billing_address': forms.TextInput(attrs={'class': 'form-control', 'placeholder': ''}),
...
LineItemFormset = modelformset_factory(LineItem, form=LineItemForm, extra=1, can_delete=True)
